...
void Atest1Character::requestAd()
{
	UE_LOG(LogTemp, Warning, TEXT("requestAd"));
	
	//UAdColonyComponent::ShowAdColonyInterstitialVideo();
}

void Atest1Character::logAdAvailable(FString ad_id)
{
	UE_LOG(LogTemp, Warning, TEXT("Resolved Ad Id is %s"), *ad_id);
}
